...
// full Do tipo bool em trips quando eu checar pelo Id do carro

// Retorna nome do condutor.
 ...
 * @param   int places: Number of places available
...
function registerTrip(){
    ...
    $places       = validate("places", "REQUEST");
    ...
    if (!($from and $to and $hour_depart and $hour_arrival and $direction and $places and $date and $description and $hash and $conversation_id)){
